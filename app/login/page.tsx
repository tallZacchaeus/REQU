  ...
  return (
    <div className="animate-fade flex h-full flex-col justify-center">
      ...
      <button
        type="button"
        onClick={onOpen}
        className="btn-gradient mt-5 flex h-11 w-full cursor-pointer items-center justify-center gap-2 rounded-lg text-[15px] font-semibold text-white shadow-raised transition-[filter,transform] duration-200 hover:brightness-110 active:scale-[0.99]"
      >
